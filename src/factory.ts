...
import { LinkedFinanceWorldFactory, Pair, Token, Bundle } from "../generated/schema";
...
export function handlePairCreated(event: PairCreated): void {
  let factory = LinkedFinanceWorldFactory.load(FACTORY_ADDRESS);
  log.info("FACTORY ADDR: {}", [FACTORY_ADDRESS]);
  if (factory === null) {
    log.info("FACTORY ADDR: NOT NULL", []);
    factory = new LinkedFinanceWorldFactory(FACTORY_ADDRESS);
